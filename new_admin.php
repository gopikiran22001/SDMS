...
if (isset($_POST['upload'])) {
    ...
    <?php
         ...
         else
         {
            if(strlen($pass)>=8)
            {
                $sql = "INSERT INTO admin(fname,lname,gender,dob,phone,mail,address,username,password,img,type) VALUES ('$fname','$lname','$gender','$dob','$phone','$mail','$address','$username','$pass','$filename','emp')";
